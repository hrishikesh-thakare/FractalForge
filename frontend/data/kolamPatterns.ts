...
export const SYMMETRY_TRANSFORMS = {
	...
	// h_self and v_self: patterns that are self-symmetric
	// h_self=find(h_inv==1:16); v_self=find(v_inv==1:16);
	horizontalSymmetric: [1, 2, 5, 10, 11, 12, 16], // where h_inv[i-1] == i
	verticalSymmetric: [1, 3, 5, 10, 11, 14, 16],   // where v_inv[i-1] == i
};
